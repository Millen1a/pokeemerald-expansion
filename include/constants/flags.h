...
#define FLAG_RECEIVE_STARTER    0x23 // Unused Flag
#define FLAG_RECEIVE_STARTERPAIR1    0x24 // Unused Flag
#define FLAG_RECEIVE_STARTERPAIR2    0x25 // Unused Flag
#define FLAG_RECEIVE_STARTERPAIR3    0x26 // Unused Flag
...
#define FLAG_SYS_B_DASH                             (SYSTEM_FLAGS + 0x60) // RECEIVED Running Shoes Unused Flag but test for now
